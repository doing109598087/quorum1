...
def get_all_quorum_continuous_overlap(quorum_system):
    ...
    for i in range(len(first_two_quorum_continuous_overlap)):
        ...
        for quorum in quorum_system:
            if first_two_quorum_continuous_overlap[i][0] in quorum and first_two_quorum_continuous_overlap[i][1] in quorum:
                continue
            else:
...
get_all_quorum_continuous_overlap([[0, 1], [0, 1], [0, 1]])
